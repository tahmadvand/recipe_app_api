...
class CommandsTestCase(TestCase):
    ...
    def test_wait_for_db_ready(self):
        ...
        with patch('django.db.utils.ConnectionHandler.__getitem__') as gi:
            ...
            # return this value that we specify here and the second thing is it allows us to
            # monitor how many times it was called and the different calls that were made to it
    ...
    def test_wait_for_db(self, ts):
        ...
        with patch('django.db.utils.ConnectionHandler.__getitem__') as gi:
            ...
            #  the first five times you call this get item it's going to raise the
            # operational error.
            # then on the sixth time it won't raise the error it will just return.
            call_command('wait_for_db')
